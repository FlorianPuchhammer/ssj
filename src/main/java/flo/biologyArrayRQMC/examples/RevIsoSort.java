...
public class RevIsoSort extends MultDimToOneDimSort{
	...
	public RevIsoSort(double[] coeffs, int[][] varIndices, boolean bias) {
		this.dimension = 2;
	...
	public RevIsoSort(double[] coeffs, int[][] varIndices, boolean bias, int step) {
		this.dimension = 2;
		this.step = step;
		this.coeffs = new double [coeffs.length];
		for(int i = 0; i < coeffs.length; i++)
