...
public class HestonModelEuropeanTest extends ArrayOfComparableChains<HestonModelEuropeanComparable> {

	public HestonModelEuropeanTest (HestonModelEuropeanComparable baseChain) {
		super(baseChain);
        //  this.baseChain = baseChain;
	}
	public void testMethods (HestonModelEuropeanComparable hesto,
		...
		String outFile = "HestonEuropeanFlattice" + sor +".txt";
		...
		statMC.init();
		hesto.simulRunsWithSubstreams(nMC, hesto.d, new MRG32k3a(), statMC);
	...
	/*	for (s = 0; s < numSets; ++s) {
		...
		str =testVarianceRateFormat(pointSets, randShift, sort, sortCoordPts, numSteps, m, varMC,
				sor + "HestonEuropeanF-var-indep", "Independent points");
		...
		// Stratification
				...
				str =testVarianceRateFormat(pointSets, randShift, sort, sortCoordPts, numSteps, m, varMC,
						sor + "HestonEuropeanF-var-Stratification", " Stratification");
				System.out.println(str);
				sb.append(str + "\n");
		...
		// Sobol + LMS
				...
				str =testVarianceRateFormat(pointSets, randDigital, sort, 0, numSteps, m, varMC,
						sor + "HestonEuropeanF-var-Sobol + LMS", "Sobol + LMS");
				System.out.println(str);
				sb.append(str + "\n");
				...
				str =testVarianceRateFormat(pointSets, randDigital, sort, 0, numSteps, m, varMC,
						sor + "HestonEuropeanF-var-Sobol + LMS + Baker", "Sobol + LMS+Baker");
				System.out.println(str);
				sb.append(str + "\n");
		...
		str =testVarianceRateFormat (pointSets, randNUS, sort, 0,
				 numSteps, m, varMC, sor + "HestonEuropeanF-var-Sobol + NUS", "Sobol + NUS");
		System.out.println (str);
		sb.append(str + "\n");
	 ...
	 // Korobov
	 		...
	 		str =testVarianceRateFormat(pointSets, randShift, sort, 0, numSteps, m, varMC,
	 				"HestonEuropeanF-var-korobov", " Korobov");
	 		System.out.println(str);
	 		sb.append(str + "\n");
	 		// Korobov + baker
	 		...
	 		str=testVarianceRateFormat(pointSets, randShift, sort, 0, numSteps, m, varMC,
	 				"HestonEuropeanF-var-korobov-Baker", " Korobov + Baker");
	 		System.out.println(str );
	 		sb.append(str + "\n");
	 		 // Korobov
	 		for (s = 0; s < numSets; ++s) {
	 		...
	 		str =testVarianceRateFormat(pointSets, randShift, sort, 0, numSteps, m, varMC,
	 				"HestonEuropeanF-var-korobovstandard", " Korobovstandard");
	 		System.out.println(str);
	 		sb.append(str + "\n");
	 		// Korobov + baker
	 		...
	 		str =testVarianceRateFormat(pointSets, randShift, sort, 0, numSteps, m, varMC,
	 				"HestonEuropeanF-var-korobovstandard-Baker", " Korobovstandard + Baker");
	 		System.out.println(str);
	 		sb.append(str + "\n");*/
	 	...
	 	// lattice
			...
			str =testVarianceRateFormat(pointSets, randShift, sort, 0, numSteps, m, varMC,
					sor + "HestonEuropeanF-var-Lattice", "Lattice");
			System.out.println(str);
			sb.append(str + "\n");
			...
			str =testVarianceRateFormat(pointSets, randShift, sort, 0, numSteps, m, varMC,
					sor + "HestonEuropeanF-var-Lattice+baker", "Lattice+baker");
			System.out.println(str);
			sb.append(str + "\n");
	...
	public static void usage() {
		System.err.println("usage: HestonEuropeanTest { split | batch | hilbertbatch | hilbert { normal | logistic <x0> <w> | logisticGC <mu> <c> } }");
		System.err.println("examples:");
		System.err.println("    HestonEuropeanTest split");
		System.err.println("    HestonEuropeanTest batch");
		System.err.println("    HestonEuropeanTest hilbert normal");
		System.err.println("    HestonEuropeanTest hilbert logistic 0.0 2.0");
	}
	...
	public static void main(String[] args) throws IOException {
		...
		HestonModelEuropeanComparable.RealsTo01Map map = null;
		...
		if (sortType.equals("hilbert")) {
			...
			if (args.length == 2 && args[1].equals("normal")) {
				...
				map = new HestonModelEuropeanComparable.NormalCDFMap();
			}
				...
				map = new HestonModelEuropeanComparable.LogisticGCMap(mu - c, mu + c);
			}
				...
				map = new HestonModelEuropeanComparable.LogisticMap(x0, w);
			}
			else {
				usage();
				System.exit(1);
		...
		HestonModelEuropeanComparable hesto = new HestonModelEuropeanComparable(r,sigma,T,d,lambda,xi,S0,V0,K,correlation,map);
		
		HestonModelEuropeanTest test = new HestonModelEuropeanTest(hesto);   
		// PointSetRandomization rand = new RandomShift(new MRG32k3a());
		MultiDimSort<HestonModelEuropeanComparable> sort;
		...
		if (sortType.equals("split")) {
			...
			sort = new SplitSort<HestonModelEuropeanComparable> (2);
			test.testMethods (hesto, sort, 2,d, m, numSets,"split4");
		}
		else if (sortType.equals("batch")) {
			System.out.println("\n******************************************");
			System.out.println("\nsort type: BATCH SORT\n");
			sort = new BatchSort<HestonModelEuropeanComparable>(batchExp);    
			test.testMethods(hesto, sort, 2, d, m, numSets,"batch4");
		}
		else if (sortType.equals("hilbertbatch")) {
			System.out.println("\n******************************************");
			System.out.println("\nsort type: HILBERT BATCH SORT\n");
			sort = new HilbertCurveBatchSort<HestonModelEuropeanComparable>(batchExp, 20);
