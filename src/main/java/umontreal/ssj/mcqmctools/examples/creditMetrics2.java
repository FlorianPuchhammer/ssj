...
public class creditMetrics2 implements MonteCarloModelDouble {
	...
	public creditMetrics2(String filename, double[][] sigma, RandomStream utilStream) throws FileNotFoundException {
		readCredit(filename);
	...
	public creditMetrics2(String filename, RandomStream utilStream) throws FileNotFoundException {
		readCredit(filename);
		this.dimension = listK.size();
	...
	public creditMetrics2(String filename, double[][] sigma) throws FileNotFoundException {
		this(filename, sigma, new MRG32k3a());
	}

	public creditMetrics2(String filename) throws FileNotFoundException {
	 ...
	 * @param sigma
	 */
	public creditMetrics2(List<Credit> listK, double[][] sigma, RandomStream utilStream) {
		this.listK = listK;
		this.sigma = MultinormalPCAGen.decompPCA(sigma);
		this.dimension = listK.size();
		this.utilStream = utilStream;
	...
	public creditMetrics2(List<Credit> listK, double[][] sigma) {
...
//	         System.out.println("TEST: sigma\t" + sqrtSigma.toString());
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		creditMetrics2 portfolio = new creditMetrics2(filename);
