...
/**
 * Implements a single instance of a weight for lattice-search-algorithms (rank-1-lattices, to be more specific)
 *  as, e.g., those implemented in *LatNetBuilder*. The template parameter 'T' indicates the data type of the 
